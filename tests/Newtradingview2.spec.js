...
if (!fs.existsSync(downloadFolder)) {
    ...
    for (let i = 0; i < values1.length; i++) {
        ...
        try {
            ...
            await page.fill('input[data-role="search"]', 'Double Simple Moving Average');

            // Define selectors for "Moving Average Simple"
            const movingAverageSimpleSelector = 'div[data-title="Double Simple Moving Average"]';
            ...
            await page.locator('input.input-RUSovanF').nth(0).fill('100');

            await page.locator('input.input-RUSovanF').nth(1).fill('200');
